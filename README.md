...
Senior Full Stack and GIS Developer with deep expertise in **Node.js**, **PostgreSQL/PostGIS**, **React**, **Flutter**, and **OGC-compliant mapping stacks** (OpenLayers, GeoServer, Leaflet, Mapbox). I design systems that combine spatial data, transactional workflows, and operational reporting at scale—from county-wide farmer platforms serving **20,000+ users** to national monitoring dashboards across **47 counties**.

**Education:** BSc Geoinformatics (TU-K) · Diploma Full-Stack Software Development (IST)

**Affiliations:** Institution of Surveyors of Kenya · Humanitarian OpenStreetMap (OSM Kenya)

---

## Tech Stack

**Frontend** `React` `Vite` `Next.js` `HTML5` `CSS3` `SASS`

**Backend** `Node.js` `Express` `Python` `REST APIs` `Webhooks` `Redis`
...
| Metric | |
|--------|---|
| Production systems delivered | **10+** county-wide platforms |
| Active end users supported | **20,000+** |
| Counties served (agriculture & LIMS) | **13+** |
| Technical consulting revenue | **KShs 200M+** |
| GitHub repositories | **120+** (public & private) |
